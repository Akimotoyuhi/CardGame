...
public class BattleManager : MonoBehaviour
{
    ...
    {
        m_hand.AllCast();
        GameManager.Instance.RelicExecute(RelicTriggerTiming.TurnEnd, ParametorType.Other, m_currentTurn);
        m_player.TurnEnd();
        m_currentTurn++;
    }
    ...
    {
        Debug.Log(m_currentTurn + "ターン目");
        GameManager.Instance.RelicExecute(RelicTriggerTiming.TurnBegin, ParametorType.Other, m_currentTurn);
        m_player.TurnStart();
